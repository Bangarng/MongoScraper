...
// This will get the articles scraped and saved in db, then show them in the list.
...
router.post("/scrape", function(req, res) {
  ...
  request("https://www.gocomics.com/comics/trending", function(error, response, html) {
    ...
    $(".gc-deck").each(function(i, element) {
      ...
      console.log("What is the picture link? " + result.picture);
...
router.post("/save", function(req, res) {
  ...
  Article.create(entry, function(err, doc) {
    // Log any errors
    if (err) {
      console.log(err);
    }
